...
export const AboutSection: React.FC = () => {
  const field = usePortalSection('about');
  const cmsItems = field('metricsJson', ABOUT_METRICS);
  return (
    <section
      id="tentang"
    ...
    >
      <Container size="default">
        ...
        <div className="text-center max-w-[860px] mx-auto mb-12 sm:mb-16 flex flex-col items-center">
          <Eyebrow>{field('eyebrow', 'TENTANG KAMI')}</Eyebrow>
          <div className="max-w-[820px] text-center">
            <StaggerHeading
              as="h2"
              text={field('headline', 'Menghadirkan Inovasi Teknologi dengan Integrasi Berkelanjutan')}
